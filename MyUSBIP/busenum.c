...
--*/
{
	...
	// 当驱动成功调用IoWMIRegistrationControl后，系统会在任意时刻发送此消息
	// 当用户请求此种数据时，也触发此消息
	DriverObject->MajorFunction[IRP_MJ_SYSTEM_CONTROL] = Bus_SystemControl; //wmi
...

{
	...
	if (result == 2) {
		...
		//
		KdPrint(("Bus_IncIoCount : result==2\n"));
